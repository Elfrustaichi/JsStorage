...
function tableShow() {
    ...
    filteredWorkers.forEach((worker) => {
      ...
      nameCell.appendChild(document.createTextNode(JSON.parse(localStorage.getItem(idStorage)).name));
      newRow.appendChild(nameCell);
  
      const surnameCell = document.createElement("td");
      surnameCell.appendChild(document.createTextNode(JSON.parse(localStorage.getItem(idStorage)).surname));
      newRow.appendChild(surnameCell);
  
      const salaryCell = document.createElement("td");
      salaryCell.appendChild(document.createTextNode(JSON.parse(localStorage.getItem(idStorage)).salary));
      newRow.appendChild(salaryCell);
  
      const positionCell = document.createElement("td");
      positionCell.appendChild(document.createTextNode(JSON.parse(localStorage.getItem(idStorage)).position));
